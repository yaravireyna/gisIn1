    ...
    <section id="facts">
      <div class="container wow fadeIn">
        <div class="section-header  fadeInUp">
          ...
          <p class="section-description wow fadeInUp">Ayudamos  a nuestros clientes  a superar los retos  que se presentan en su tecnología  en desuso, dándole  la gestión a su ciclo de vida. A la vez que protegemos  de manera  exhaustiva  los datos confidenciales y documentar que se ha cumplido toda la regulación relevante de seguridad tanto ambientales  como industriales.</p>
        </div>
        <div class="row">
              ...
              <div class="container wow fadeIn">
                <div class="row">
                  <div class="col-12 animated fadeInDown">
                    <p>Nuestros servicios Asset Recovery permiten resolver a las empresas sus retos de disposición de tecnología en desuso. ya sea reacondicionando unidades para su reúso, en recolocación o aprovechamiento de metales preciosos. Con resultados de alta cálidad y responsabilidad ambiental.</p>
                    <p>Nos destacamos en la recuperación  y visibilidad  de los procesos manteniendo siempre lo más altos niveles de seguridad física y de la información  en cada paso.</p>
                    <p>
                      <h2>Objetivos del proceso</h2>
                      <ul>
                        <li>Proteger información</li>
                        <li>Minimizar impacto ambiental</li>
                        <li>Evitar almacenamiento y otros procesos</li>
                        <li>Garantizar la cadena de custodia del Hardware</li>
                        <li>Generar recuperación</li>
                      </ul>          
                    </p>
                  </div>
            ...
            <section id="success">
              <div class="container wow fadeIn">
                <div class="row wow fadeInUp">                           
                  <div class="col-12"><h2>Caso de éxito</h2>
                    <p>
                      “En GrupoIS valoramos la inversión de su empresa y la recuperación de recursos. Por ende, con nuestro sistema de Asset Recovery hemos logrado rescatar a más de 1500 equipos que se encontraron en desuso, uno de nuestros clientes recuperó el 100% de inversión que creía perdida.
                    </p>                    
                    <!-- <p class="firma">- </p> -->
                  </div>
                </div>
